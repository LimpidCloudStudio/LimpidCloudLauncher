...
DownloadGameJson = ttk.Button(MainWind, text="下载JSON", takefocus=False,)
LoadModPacks = ttk.Button(MainWind, text="安装整合包", takefocus=False,)
NewsFrame_0 = ttk.Frame()
NewsFrame_0.place(x=541, y=77, width=100, height=204)
NewsFrame_1 = ttk.Frame()
NewsFrame_1.place(x=541, y=77, width=100, height=204)
NewsFrame = ttk.Notebook(MainWind)
NewsFrame.add(NewsFrame_0, text="推荐")
NewsFrame.add(NewsFrame_1, text="最新")
Progressbar = ttk.Progressbar(MainWind, orient=HORIZONTAL,)
...
DownloadGameJson.place(x=540, y=290, width=103, height=30)
LoadModPacks.place(x=540, y=40, width=102, height=30)
NewsFrame.place(x=541, y=77, width=100, height=204)
Progressbar.place(x=70, y=16, width=454, height=14)
